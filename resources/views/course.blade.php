...
@section('Main')
    ...
    <div class="container">
        <h3>Sprint 1</h3>
        {{ $course->week }}
        {{-- data ophalen uit de database van sprint 1 --}}
        @include('carrousel', ['amount' => '2', 'sprint' => '1'])

        <h3>Sprint 2</h3>
        {{-- data ophalen uit de database van sprint 2 --}}
        @include('carrousel', ['amount' => '2', 'sprint' => '2'])

        <h3>Sprint 3</h3>
        {{-- data ophalen uit de database van sprint 3 --}}
        @include('carrousel', ['amount' => '3', 'sprint' => '3'])

        <h3>Sprint 4</h3>
        {{-- data ophalen uit de database van sprint 4 --}}
        @include('carrousel', ['amount' => '4', 'sprint' => '4'])

        <h3>Sprint 5</h3>
        {{-- data ophalen uit de database van sprint 5 --}}
